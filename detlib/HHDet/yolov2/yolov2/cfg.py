...
#    conv_model.bias.preprocesser.copy_(torch.from_numpy(buf[start:start+num_b]));   start = start + num_b
#    conv_model.weight.preprocesser.copy_(torch.from_numpy(buf[start:start+num_w])); start = start + num_w
#    return start
...
#    bn_model.bias.preprocesser.copy_(torch.from_numpy(buf[start:start+num_b]));     start = start + num_b
#    bn_model.weight.preprocesser.copy_(torch.from_numpy(buf[start:start+num_b]));   start = start + num_b
