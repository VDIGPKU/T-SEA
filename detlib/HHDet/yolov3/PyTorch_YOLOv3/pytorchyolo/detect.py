...
def run():
    ...
    parser.add_argument("-i", "--images", type=str, default="preprocesser/samples", help="Path to directory with images to inference")
    parser.add_argument("-c", "--classes", type=str, default="preprocesser/coco.names", help="Path to classes label file (.names)")
